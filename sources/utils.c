...
int ctoh(TCHAR ch)
{
	...
	case TEXT('1'): return 1;
	case TEXT('2'): return 2;
	case TEXT('3'): return 3;
	case TEXT('4'): return 4;
	case TEXT('5'): return 5;
	case TEXT('6'): return 6;
	case TEXT('7'): return 7;
	case TEXT('8'): return 8;
	case TEXT('9'): return 9;
	case TEXT('A'): case TEXT('a'): return 10;
	case TEXT('B'): case TEXT('b'): return 11;
	case TEXT('C'): case TEXT('c'): return 12;
	case TEXT('D'): case TEXT('d'): return 13;
	case TEXT('E'): case TEXT('e'): return 14;
	case TEXT('F'): case TEXT('f'): return 15;
	default: return -1;
	}
}
